    ...
    while (1){
        ...
        while (!endGame){
            ...
            if (input[0]=='S' && input[1]=='\0'){
                fp = fopen("Youssef_Ahmed_19016903_Abdelmoniem_Hany_19017359_SaveMeSaveMe.txt","w");
                //SAVING CURRENT BOARD
                for (i=0;i<8;i++){
                    for (j=0;j<8;j++){
                        fprintf(fp,"%c",c[i][j]);
            ...
            if (input[0]=='L' && input[1]=='\0'){
                ...
                gets(input);
                if (input[0]=='L' && input[1]=='\0'){
                    fp = fopen("Youssef_Ahmed_19016903_Abdelmoniem_Hany_19017359_SaveMeSaveMe.txt","r");
                    for (i=0;i<8;i++){
                        fgets(s,10,fp);
                        for (j=0;j<8;j++){
                            c[i][j] = s[j];
